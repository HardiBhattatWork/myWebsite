...
$vimeo_user_name = ($_GET['user']) ? $_GET['user'] : 'channel/staffpicks';
...
$user = simplexml_load_string(curl_get($api_endpoint . '/info.json'));
$videos = simplexml_load_string(curl_get($api_endpoint . '/videos.json'));
