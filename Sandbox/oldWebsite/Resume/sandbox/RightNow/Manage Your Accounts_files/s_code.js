...
var hostname  = BCUS.Tags.scode.hostname || document.location.host.toLowerCase();

var s_account = BCUS.Tags.scode.account || "barclaysglobalcm";
...
s.linkInternalFilters="javascript:,myblackcard.com,haacard.com,llbeanrewards.com,harvardcard.com,pricelinevisa.com,blackcard.com,juniper.com,barclaycardus.com,pricelinerewardsvisa.com,llbeanvisa.com,usairwaysmastercard.com,wcm-cpd.ameriprise.com,card.ameriprise.com,travelocitymastercard.com,mytravelocityrewards.com,iambarclaycardus.com,applyairtran.com,orbitzcard.com,aerlingusrewards.com,airjamaicacard.com,airtranbizvisa.com,airtranvisa.com,ataairlinesvisacard.com,bizaccountservice.com,bjsbiz.com,bjsvisa.com,bluegreencreditcard.com,bncreditcard.com,c21mastercard.com,caesarscard.com,carnivalfunpoints.com,carnivalseamiles.com,cartersrewards.com,caseysmastercard.com,chinaairlinescreditcard.com,choiceprivilegesvisa.com,clarkmastercard.com,coastresortscard.com,demcard.com,directvrewards.com,easternbankbuscard.com,easternbankcreditcard.com,emigrantdirectmastercard.com,farmbureaucard.com,fbbcard.com,freespiritbusinesscard.com,freespiritmastercard.com,frontierbusinesscard.com,frontiermastercard.com,goodsamcard.com,gulfmastercard.com,harborfreightmastercard.com,hollandamericavisa.com,ibccredit.com,icelandairmastercard.com,joanncreditcard.com,juniperbiz.com,lotsmoremiles.com,lukoilmastercard.com,mailboxcard.com,maverikmastercard.com,mazdacard.com,mdpcard.com,midwestairlinesbiz.com,midwestairlinesbizpro.com,mostmiles.com,myapplicationstatus.com,mycarnivalmastercard.com,mycarnivalseamiles.com,myshopkorewards.com,mytravelocitycard.com,oshkoshrewards.com,paylesscreditcard.com,performancemastercard.com,portsupplybiz.com,princessvisa.com,racetracard.com,racetraccard.com,racetraccreditcard.com,racetrackcard.com,racetrackcreditcard.com,racewaycard.com,recrewardscard.com,servicemycard.com,sinclaircard.com,tesorocreditcard.com,tesoromastercard.com,thegconomycard.com,tivocard.com,usairwaysbiz.com,usairwayscard.com,usairwaysemployee.com,usairwayspro.com,vegasmastercard.com,viewmyterms.com,virginamericavisa.com,wyndhamrewardsvisa.com,nflextrapointscard.com,mynflcard.com,nflfansonly.com,NFLExtraPointsSweepstakes.com,KeepitNFLreal.com,mynflcreditcard.com,footballfansonly.com,thenflcard.com,ForRealFans.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Form Analysis Config (should be above doPlugins section) */
   s.formList="mmnForm,registerCreateForm,webRegistrationStart,submitForm,loginForm,loginChallengeForm,loginPasswordForm,DownloadTransForm,ExternalAccountForm,PayCreditCardForm,BalanceTransferForm,ActivationForm,SelfServiceForm,PassmarkVerificationForm,pppForm,TimeEnrollForm,CVV2Form,CustomerProfileForm,EnrollForm,creditLineForm,activateCardForm,enrollPaperlessForm,addAuthorizedUserForm,enterPINForm"	// please list all applicable form names here
   ...
   function sendActivateCard(){
      var errorCode1 = "The social security number you have entered is incorrect. Please...";
      var errorCode2 = "The security code you have entered is incorrect. Please try again.";
      var isok = true,
      validateInputs = YAHOO.util.Dom.getElementsByClassName("inputBox","input","activateCardForm"),
      ActivateFields = ["ssnDigit1","ssnDigit2","ssnDigit3","ssnDigit4","securityCode"],
      ActivateErrors = [errorCode1,errorCode1,errorCode1,errorCode1,errorCode2];

      for(i=0; i < validateInputs.length; i++){
         if(YAHOO.util.Dom.hasClass(validateInputs[i], "error") && ActivateFields[i] != ""){
            s.sendFormEvent('e','activateCardForm', 'activateCardForm', 'Error: '+ ActivateFields[i] +': '+ ActivateErrors[i] +'');isok=false;
         }
      }
      if(isok){s.sendFormEvent('s','activateCardForm', 'activateCardForm');return true;}
   }
   /*function sendPaperless(){
      var errorCode1 = "You must confirm your email.",
      errorCode2 = "You must check both boxes to enroll.",
      isok = true,
      paperlessField = YAHOO.util.Dom.get("confirmEmail","input","enrollPaperlessForm"),
      paperlessFields = YAHOO.util.Dom.getElementsByClassName("yui-checkbox-button","span","enrollPaperlessForm"),
      paperlessCheck = ["stopPaperStmts","canPrintVerification"],
      paperlessErrors = [errorCode2,errorCode2];

      if(YAHOO.util.Dom.hasClass(paperlessField, "error") || paperlessField == ""){
         s.sendFormEvent('e','enrollPaperlessForm', 'enrollPaperlessForm', 'Error: confirmEmail: '+ errorCode1 +'');isok=false;
      }
      for(i=0; i < paperlessFields.length; i++){
         if(YAHOO.util.Dom.hasClass(paperlessFields[i], "error")){
            s.sendFormEvent('e','enrollPaperlessForm', 'enrollPaperlessForm', 'Error: '+ paperlessCheck[i] +': '+ paperlessErrors[i] +'');isok=false;
         }
      }
      if(isok){s.sendFormEvent('s','enrollPaperlessForm', 'enrollPaperlessForm');return true;}
   }*/
   function sendcreditLine(){
      var errorCode1 = "Required to completely evaluate your application.";
      var isok = true,
      creditLineInputs = YAHOO.util.Dom.getElementsByClassName("inputBox","input","creditLineForm"),
      creditLineFields = ["employer","employmentYears","additionalCreditLine","totalAnnualIncome"];

      for(i=0; i < creditLineInputs.length; i++){
         if(YAHOO.util.Dom.hasClass(creditLineInputs[i], "error") && creditLineFields[i] != ""){
            s.sendFormEvent('e','creditLineForm', 'creditLineForm', 'Error: '+ creditLineFields[i] +': '+ errorCode1 +'');isok=false;
         }
      }
      if(isok){s.sendFormEvent('s','creditLineForm', 'creditLineForm');return true;}
   }
   function sendaddAuthUser(){
      var errorCode1 = "Check that you have entered only letters or spaces. Numbers, apostrophes, and other special characters can not be accepted.";
      var isok = true,
      addAuthInputs = YAHOO.util.Dom.getElementsByClassName("inputBox","input","addAuthorizedUserForm"),
      addAuthFields = ["firstName","middleInitial","lastName"];

      for(i=0; i < addAuthInputs.length; i++){
         if(YAHOO.util.Dom.hasClass(addAuthInputs[i], "error") && addAuthFields[i] != ""){
            s.sendFormEvent('e','addAuthorizedUserForm', 'addAuthorizedUserForm', 'Error: '+ addAuthFields[i] +': '+ errorCode1 +'');isok=false;
         }
      }
      if(isok){s.sendFormEvent('s','addAuthorizedUserForm', 'addAuthorizedUserForm');return true;}
   }
...
function s_doPlugins(s) {
  ...
  /* referrerID Tracking */
  s.eVar22=s.getQueryParam('referrerid');  
  ...
  if(s.getQueryParam("INTNAV") == null || s.getQueryParam("INTNAV") == ""){} else {
     s.prop20 = s.getQueryParam("INTNAV");
  }
  s.eVar21 = s.prop20;
...
+"();faLink.href='#';s.tl(faLink,'o','Form Analysis - Abandonment');s[f.vu]='';s.us"
+"ePlugins=up}return f.ul&&e!='e'&&e!='s'?f.ul(e):false;");
